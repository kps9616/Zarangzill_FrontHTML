...
<script>
    ...
    $( document ).ready(function() {
        ...
        var winPredMList = JSON.parse(response.winPredMList);
        var html = "";

        html += '<li className="rank-adv">';
        html += '    <span className="rank-adv-icon">광고</span>';
        html += '    <div className="rankimg"><a href="46-2광고.html"><img src="images/thum/thum-cu.jpg"></a></div>';
        html += '    <div className="rankinfo">';
        html += '        <div className="rankinfo-tit ellipsis2"><a href="46-2광고.html">CU편의점 고인물 편 ♡♡♡편의점 알바이야기 연속 보기</a></div>';
        html += '        <div className="c_gray ellipsis">#편의점 #CU편의점 알바이야기 #CU편의점</div>';
        html += '        <div className="c_gray font11 mb5">2023.01.02</div>';
        html += '        <div className="rankinfo-name"><a href="#none">CU편의점</a></div>';
        html += '    </div>';
        html += '</li>';

        for(var i = 0; i < winPredMList.length; i++) {
            var winPredInfo = JSON.parse(winPredMList(i));
            html += '<li>';
            ...
            html += '        <div class="rankinfo-tit ellipsis2"><a href="107쇼츠.html">'+winPredInfo.videoDescription+'</a></div>';
            html += '        <div class="c_gray ellipsis">'+winPredInfo.videoTags+'</div>';
            html += '       <div class="c_gray font11 mb5">'+winPredInfo.videoCreatedAt+'</div>';
            html += '       <div class="rankinfo-name"><a href="#none">'+winPredInfo.channelName+'</a></div>';
            html += '    </div>';
            html += '    <div class="c_gray wp60 tac font12">'+winPredInfo.videoScore+'</div>';
            html += '    <div class="c_gray wp60 tac font12">'+winPredInfo.predCnt+'</div>';
            html += '</li>';
        }
...
<body>
    ...
    <div class="container">
        <div class="tab-2th">
            <a href="45-1월우승-진행중.html" class="mleft on">월 우승</a><a href="48-1주우승-진행중.html" class="mright">주 우승</a>
        </div>
